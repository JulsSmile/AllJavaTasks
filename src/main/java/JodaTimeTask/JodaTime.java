...
public class JodaTime{
    ...
    public static void main(String[] args) {
        ...
        task1(input, formatter_YYYY_MM_DD, formatter_MM_DD_YYYY);
        task2(input, formatter_YYYY_MM_DD, formatter_DD_MM_YYYY);
        task3(input, formatter_YYYY_MM_DD, formatter_DD_MM_YYYY);
        task4(input, formatter_YYYY_MM_DD, longFormatter);
        task5(input, formatter_YYYY_MM_DD, longFormatter);
//        task6(input, longFormatter, );
//        task7(input, formatter_YYYY_MM_DD, longFormatter);
